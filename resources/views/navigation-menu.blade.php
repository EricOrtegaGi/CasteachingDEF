        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Añade tus nuevos enlaces aquí -->
                    <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('manage.series') }}" :active="request()->routeIs('manage.series')">
                        {{ __('Manage Series') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('videos.manage.index') }}" :active="request()->routeIs('videos.manage.index')">
                        {{ __('Manage Videos') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('users.manage.index') }}" :active="request()->routeIs('users.manage.index')">
                        {{ __('Manage Users') }}
                    </x-nav-link>
                </div>
            </div>
